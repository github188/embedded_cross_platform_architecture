...
typedef struct
{
	...
	//uint64_t read_start;		//读文件的开始
	uint64_t read_pos;		//读文件的位置
	//uint64_t read_end;		//能读的文件的末尾
	//uint64_t write_start;		//能写文件的开始
	uint64_t write_pos;		//当前写文件的位置
	//uint64_t write_end;		//能写的文件的末尾
} file_info_t;
