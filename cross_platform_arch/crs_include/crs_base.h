...
// crsplatform.h 编译器相关的
//
// crs_error.h

// crs_base.h // CXX_EXTERN_BEGIN/编译器相关[inline/export]/ 数据类型定义

// crs_time.h // ? 本机启动时间 // core中需要注意频率的处理要么采用内部计时器

// crs_mem.h // malloc/free/memset/memcpy  注意core代码里分配内存后需要memset(0)
...
// crs_sock.h // ntoh/hton; ntoa_r; dns; nonblock; set[get]sockopt; getsockname; select; sock recv[from] send[to] connect bind accept listen close;
//             // 减少函数调用
